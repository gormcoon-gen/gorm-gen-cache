...
func newProduct(db *gorm.DB, opts ...gen.DOOption) product {
	...
	_product.StockQuantity = field.NewInt64(tableName, "stock_quantity")
	_product.Version = field.NewInt64(tableName, "version")
...
func (p *product) updateTableName(table string) *product {
	...
	p.StockQuantity = field.NewInt64(table, "stock_quantity")
